...
__export(index_exports, {
  ...
  SessionHtmlStorage: () => SessionHtmlStorage,
  apiClient: () => apiClient,
  cleanupHtmlData: () => cleanupHtmlData,
  clearAuthenticationData: () => clearAuthenticationData,
  completeAuthenticationFlowWithDetails: () => completeAuthenticationFlowWithDetails,
  conversationStorage: () => conversationStorage,
  convertRelativeToAbsolute: () => convertRelativeToAbsolute,
  createInternalUser: () => createInternalUser,
  createSession: () => createSession,
  executeWebsiteAction: () => executeWebsiteAction,
  getAllHtmlData: () => getAllHtmlData,
  getAvailableTriggers: () => getAvailableTriggers,
  getCurrentAuthData: () => getCurrentAuthData,
  getHtmlDataByTrigger: () => getHtmlDataByTrigger,
  getHtmlStorageStats: () => getHtmlStorageStats,
  getLatestHtmlData: () => getLatestHtmlData,
  getUrlBasedConfig: () => getUrlBasedConfig,
  hasHtmlData: () => hasHtmlData,
  mergeUrlConfigWithDefaults: () => mergeUrlConfigWithDefaults,
  navigateToUrl: () => navigateToUrl,
  processDataCommand: () => processDataCommand,
  processNavigation: () => processNavigation,
  processSlashCommand: () => processSlashCommand,
  sendSimpleChatMessage: () => sendSimpleChatMessage,
  sessionManager: () => sessionManager,
  useChatInputManager: () => useChatInputManager,
  useChatStateManager: () => useChatStateManager,
  useLinks: () => useLinks,
...
var ApiClient = class {
  ...
  async performTokenRefresh() {
    try {
      const response = await import_axios.default.post(`${this.baseURL}/auth/refresh`, {
